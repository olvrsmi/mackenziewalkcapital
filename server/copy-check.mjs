...
// The opening scene has the floor at boot, and walking it is what exercises its
// copy. Generically: the script is a writer's file, so answer whatever it offers
// rather than assuming which choices exist.
let guard = 0
